...
/turf/closed/wall/mineral/copper
	...
	color = "#d95802" //To display in mapping softwares
...
/turf/closed/wall/mineral/titanium //has to use this path due to how building walls works
	...
	smoothing_groups = list(SMOOTH_GROUP_SURVIVAL_TIANIUM_POD)
	canSmoothWith = list(SMOOTH_GROUP_WALLS, SMOOTH_GROUP_AIRLOCK, SMOOTH_GROUP_WINDOW_FULLTILE, SMOOTH_GROUP_LOW_WALL)
...
/turf/closed/wall/mineral/titanium/survival
	...
	canSmoothWith = list(SMOOTH_GROUP_SURVIVAL_TIANIUM_POD, SMOOTH_GROUP_AIRLOCK, SMOOTH_GROUP_WINDOW_FULLTILE, SMOOTH_GROUP_SHUTTLE_PARTS, SMOOTH_GROUP_WALLS)
