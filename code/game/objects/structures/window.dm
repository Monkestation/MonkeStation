...
/obj/structure/window/shuttle//this is called reinforced because it is reinforced w/titanium
	...
	canSmoothWith = list(SMOOTH_GROUP_WINDOW_FULLTILE_SHUTTLE, SMOOTH_GROUP_WALLS, SMOOTH_GROUP_AIRLOCK)
	explosion_block = 3
...
/obj/structure/window/paperframe
	...
	//canSmoothWith = list(/obj/structure/window/paperframe, /obj/structure/mineral_door/paperframe) //MONKESTATION REMOVAL
	glass_amount = 2
