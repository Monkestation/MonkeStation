...
/obj/item/toy/whoopee
	...
	desc = "A toy as old as Rome.  Also known as a farting bag, pooting cushion, windy blaster, razzberry cushion..."
	attack_verb = list("farted", "pooted", "whoopeed", "stinked", "pranked")
	icon = 'icons/obj/toy.dmi'
	icon_state = "whoopee"
	var/farts = list('sound/misc/fart1.ogg', 'monkestation/sound/effects/fart2.ogg', 'monkestation/sound/effects/fart3.ogg', 'monkestation/sound/effects/fart4.ogg')
