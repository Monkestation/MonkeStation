...
/obj/item/wallframe/attackby(obj/item/W, mob/user, params)
	...
	var/iron_amt = round(custom_materials[/datum/material/iron]/MINERAL_MATERIAL_AMOUNT) //Replace this shit later
	var/glass_amt = round(custom_materials[/datum/material/glass]/MINERAL_MATERIAL_AMOUNT) //Replace this shit later
