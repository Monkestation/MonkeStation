...
/obj/item/airlock_painter/Destroy()
	. = ..()
	if(ink)
		qdel(ink)
...
/obj/item/airlock_painter/decal/proc/paint_floor(turf/open/floor/target)
	target.AddElement(/datum/element/decal, 'icons/turf/decals.dmi', stored_decal_total, stored_dir, TRUE, color, TURF_LAYER, null, alpha, null)
...
/obj/item/airlock_painter/decal/tile/paint_floor(turf/open/floor/target)
	...
	target.AddElement(/datum/element/decal, 'icons/turf/decals.dmi', source_decal, source_dir, TRUE, stored_color, TURF_LAYER, null, stored_alpha, null)
