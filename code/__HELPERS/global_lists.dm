...
/proc/make_datum_references_lists()
	...
	for(var/KB in subtypesof(/datum/keybinding))
		...
		if((!initial(keybinding.key) && !initial(keybinding.goon_key)) || !initial(keybinding.keybind_signal))
			continue
	...
	for(var/key in GLOB.goon_keybinding_list_by_key)
