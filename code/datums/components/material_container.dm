...
/datum/component/material_container/proc/insert_item(obj/item/I, var/multiplier = 1, stack_amt, breakdown_flags= mat_container_flags)
	if(QDELETED(I))
		return FALSE
	...
	last_inserted_id = insert_item_materials(I, multiplier, mat_container_flags)
