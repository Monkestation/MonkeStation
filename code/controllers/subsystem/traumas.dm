...
/datum/controller/subsystem/traumas/Initialize()
	...
	phobia_mobs = list("spiders"  = typecacheof(list(/mob/living/simple_animal/hostile/poison/giant_spider)),
					   "security" = typecacheof(list(/mob/living/simple_animal/bot/secbot, /mob/living/simple_animal/bot/secbot/ed209)),
					   ...
					   "conspiracies" = typecacheof(list(/mob/living/simple_animal/bot/secbot, /mob/living/simple_animal/bot/secbot/ed209, /mob/living/simple_animal/drone,
	...
	phobia_objs = list("snakes" = typecacheof(list(/obj/item/rod_of_asclepius)),
					  ...
					  "lizards"   = typecacheof(list(/obj/item/toy/plush/lizard_plushie, /obj/item/food/kebab/tail,
