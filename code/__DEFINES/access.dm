...
#define ACCESS_PHARMACY 73 ///Nice.
#define ACCESS_PSYCHOLOGY 74
/// Toxins gas storage room access
#define ACCESS_TOX_STORAGE 75
/// Service access, for service hallway and service consoles
#define ACCESS_SERVICE 76
...
/// Pirate ship access
#define ACCESS_PIRATES 180
/// Bounty hunter access
#define ACCESS_HUNTERS 181
...
/// Not currently used but are used for an id_acccess.dm which are for a "Non-processing subsystem that holds various procs and data structures to manage ID cards, trims and access." Could be a nice QoL change next
