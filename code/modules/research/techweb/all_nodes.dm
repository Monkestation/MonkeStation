...
/datum/techweb_node/basic_circuitry
	...
	design_ids = list("integrated_circuit", "circuit_multitool", "comp_arithmetic", "comp_clock", "comp_combiner", "comp_comparison", "comp_delay",
		"comp_direction", "comp_get_column", "comp_gps", "comp_health", "comp_sec", "comp_hear", "comp_light", "comp_logic", "comp_index_table", "comp_mmi", "comp_multiplexer", "comp_not", "comp_ram",
		...
		"comp_typecheck", "compact_remote_shell", "component_printer", "comp_string_contains", "usb_cable") //Monkestation Added: "comp_sec"
