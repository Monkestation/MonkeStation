...
/datum/techweb_node/engineering
	...
	"oxygen_tank", "plasma_tank", "emergency_oxygen", "emergency_oxygen_engi", "plasmaman_tank_belt", "electrolyzer", "plasmaman_tank", "antivirus2", "liquid_output_pump")//MONKESTATION CHANGE
