...
/datum/action/item_action/ninjaboost
	check_flags = NONE
	name = "Repair Nanopaste"
	desc = "Repairs critical wounds and keeps you in the fight, but at a cost of cellular health."
...
/obj/item/clothing/suit/space/space_ninja/proc/ninjaboost()
	...
	nanopaste_available = FALSE
	to_chat(ninja, "<span class='notice'>You have used your nanopaste. Gather more by striking worthy foes with your blade.</span>")
	suit_cooldown = 6
