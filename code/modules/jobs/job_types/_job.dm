/datum/job
	...
	//MonkeStation Edit: Port of /tg/'s mail system
...
/datum/job/proc/get_access()
	...
	if(CONFIG_GET(flag/jobs_have_minimal_access))
		...
		. += list(	ACCESS_KITCHEN, ACCESS_ENGINE, ACCESS_ENGINE_EQUIP, ACCESS_TECH_STORAGE, ACCESS_MINING, ACCESS_MINING_STATION, ACCESS_RESEARCH,
					ACCESS_EXTERNAL_AIRLOCKS, ACCESS_CONSTRUCTION, ACCESS_MINERAL_STOREROOM, ACCESS_MEDICAL, ACCESS_CARGO, ACCESS_ROBOTICS,
					ACCESS_SURGERY, ACCESS_CLONING, ACCESS_MECH_MEDICAL, ACCESS_MINERAL_STOREROOM, ACCESS_MAILSORTING, ACCESS_MAINT_TUNNELS)
		//MonkeStation Edit End
