...
/datum/gas_mixture/proc/get_by_flag(flag) //MONKESTATION ADDITION
/datum/gas_mixture/proc/set_moles(gas_type, moles)
/datum/gas_mixture/proc/scrub_into(datum/gas_mixture/target, ratio, list/gases)
/datum/gas_mixture/proc/mark_immutable()
/datum/gas_mixture/proc/get_gases()
/datum/gas_mixture/proc/add(amt) //MONKESTATION ADDITION
/datum/gas_mixture/proc/subtract(amt) //MONKESTATION ADDITION
/datum/gas_mixture/proc/multiply(factor)
/datum/gas_mixture/proc/divide(factor) //MONKESTATION ADDITION
...
/datum/gas_mixture/proc/adjust_moles_temp(gas_type, amt, temperature) //MONKESTATION ADDITION

/datum/gas_mixture/proc/adjust_multi() //MONKESTATION ADDITION
...
/datum/gas_mixture/proc/remove_by_flag(flag, amount) //MONKESTATION ADDITION
