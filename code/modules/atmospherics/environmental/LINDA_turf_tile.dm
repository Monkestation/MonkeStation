...
/turf/open/proc/high_pressure_movements()
	...
	if(pressure_difference > 100) //MONKESTATION EDIT ADDITIONS
		new /obj/effect/temp_visual/dir_setting/space_wind(src, pressure_direction, CLAMP(round(sqrt(pressure_difference) * 2), 10, 255)) //MONKESTATION EDIT ADDITIONS
