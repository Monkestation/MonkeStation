...
/mob/living/carbon/proc/natural_bodytemperature_stabilization()
	var/normal_bodytemp = BODYTEMP_NORMAL
	...
	switch(bodytemperature)
		...
		if(BODYTEMP_COLD_DAMAGE_LIMIT to normal_bodytemp)
		...
		if(normal_bodytemp to BODYTEMP_HEAT_DAMAGE_LIMIT) // Heat damage limit is 50 above the default, the temperature where you start to feel effects.
