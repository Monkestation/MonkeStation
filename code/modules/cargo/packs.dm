...
/datum/supply_pack/service/randomized/donkpockets
	...
	cost = 2000
	contains = list(/obj/item/storage/box/donkpockets/donkpocketspicy = 8,
	/obj/item/storage/box/donkpockets/donkpocketteriyaki = 8,
	/obj/item/storage/box/donkpockets/donkpocketpizza = 8,
	/obj/item/storage/box/donkpockets/donkpocketgondola = 2,
	/obj/item/storage/box/donkpockets/donkpocketberry = 8,
	/obj/item/storage/box/donkpockets/donkpockethonk = 5)
	crate_name = "donk pocket crate"

/datum/supply_pack/service/randomized/donkpockets/fill(obj/structure/closet/crate/C)
	for(var/i in 1 to 6)
		var/item = pickweight(contains)
		new item(C)
...
/datum/supply_pack/organic/cream_piee
	...
	crate_name = "party equipment crate"
	contraband = TRUE
	crate_type = /obj/structure/closet/crate/secure/clown //Monkestation Edit - made it clown crate
