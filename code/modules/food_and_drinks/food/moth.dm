...
/obj/item/food/grilled_cheese
	...
	food_reagents = list(/datum/reagent/consumable/nutriment = 5, /datum/reagent/consumable/char = 1)
...
/obj/item/food/engine_fodder
	...
	food_reagents = list(/datum/reagent/consumable/nutriment/vitamin = 2, /datum/reagent/consumable/sugar = 3, /datum/reagent/consumable/nutriment = 2, /datum/reagent/consumable/sodiumchloride = 1)
...
/obj/item/food/sweet_chili_cabbage_wrap
	...
	food_reagents = list(/datum/reagent/consumable/nutriment = 3, /datum/reagent/consumable/nutriment/vitamin = 4, /datum/reagent/consumable/capsaicin = 1)
...
/obj/item/food/loaded_curds
	...
	food_reagents = list(/datum/reagent/consumable/nutriment = 6, /datum/reagent/consumable/nutriment/vitamin = 2, /datum/reagent/consumable/capsaicin = 1)
...
/obj/item/food/green_lasagne
	...
	food_reagents = list(/datum/reagent/consumable/nutriment = 12, /datum/reagent/consumable/nutriment/vitamin = 18)
	tastes = list("cheese" = 1, "pesto" = 1, "pasta" = 1)
	foodtypes = VEGETABLES | GRAIN | NUTS
	w_class = WEIGHT_CLASS_NORMAL
	burns_in_oven = TRUE
...
/obj/item/food/big_baked_rice
	...
	food_reagents = list(/datum/reagent/consumable/nutriment = 12, /datum/reagent/consumable/nutriment/vitamin = 36)
	tastes = list("rice" = 1, "potato" = 1, "veggies" = 1)
	foodtypes = VEGETABLES | GRAIN
	w_class = WEIGHT_CLASS_NORMAL
	burns_in_oven = TRUE
...
/obj/item/food/buttered_baked_corn
	...
	food_reagents = list(/datum/reagent/consumable/nutriment = 2, /datum/reagent/consumable/nutriment/vitamin = 4, /datum/reagent/consumable/char = 1)
	tastes = list("corn" = 1, "char" = 1)
...
/obj/item/food/fiesta_corn_skillet
	...
	food_reagents = list(/datum/reagent/consumable/nutriment = 3, /datum/reagent/consumable/nutriment/vitamin = 7, /datum/reagent/consumable/char = 1)
...
/obj/item/food/soup/moth_cheese_soup
	...
	food_reagents = list(/datum/reagent/consumable/nutriment = 5, /datum/reagent/consumable/sodiumchloride = 1)
...
/obj/item/food/soup/vegetarian_chili
	...
	icon_state = "hotchili"
	food_reagents = list(/datum/reagent/consumable/nutriment = 8, /datum/reagent/consumable/capsaicin = 3, /datum/reagent/consumable/tomatojuice = 4, /datum/reagent/consumable/nutriment/vitamin = 4)
	tastes = list("bitterness" = 1, "sourness" = 1)
	foodtypes = VEGETABLES
	w_class = WEIGHT_CLASS_SMALL
...
/obj/item/food/soup/hua_mulan_congee
	...
	food_reagents = list(/datum/reagent/consumable/nutriment = 5, /datum/reagent/consumable/nutriment/vitamin = 5, /datum/reagent/consumable/nutriment = 5)
...
/obj/item/food/raw_mothic_margherita
	...
	food_reagents = list(/datum/reagent/consumable/nutriment = 20, /datum/reagent/consumable/tomatojuice = 6, /datum/reagent/consumable/nutriment/vitamin = 3)
...
/obj/item/food/pizza/mothic_margherita
	...
	food_reagents = list(/datum/reagent/consumable/nutriment = 33, /datum/reagent/consumable/tomatojuice = 6, /datum/reagent/consumable/nutriment/vitamin = 5)
...
/obj/item/food/raw_mothic_firecracker
	...
	food_reagents = list(/datum/reagent/consumable/nutriment = 20, /datum/reagent/consumable/bbqsauce = 6, /datum/reagent/consumable/nutriment/vitamin = 3, /datum/reagent/consumable/capsaicin = 10)
...
/obj/item/food/pizza/mothic_firecracker
	...
	food_reagents = list(/datum/reagent/consumable/nutriment = 33, /datum/reagent/consumable/bbqsauce = 6, /datum/reagent/consumable/nutriment/vitamin = 5, /datum/reagent/consumable/capsaicin = 10)
...
/obj/item/food/moth_cheese_cakes
	...
	food_reagents = list(/datum/reagent/consumable/nutriment = 5, /datum/reagent/consumable/sugar = 5)
