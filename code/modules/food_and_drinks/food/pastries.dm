...
/obj/item/food/donut/meat
	...
	food_reagents = list(/datum/reagent/consumable/nutriment = 5, /datum/reagent/consumable/ketchup = 3)
	tastes = list("meat" = 1)
...
/obj/item/food/donut/choco
	...
	food_reagents = list(/datum/reagent/consumable/nutriment = 3, /datum/reagent/consumable/sugar = 3, /datum/reagent/consumable/cocoa/hot_cocoa = 3, /datum/reagent/consumable/sprinkles = 1) //the coco reagent is just bitter.
...
/obj/item/food/donkpocket/warm
	...
	food_reagents = list(/datum/reagent/consumable/nutriment = 5, /datum/reagent/medicine/omnizine = 6)
...
/obj/item/food/donkpocket/spicy
	...
	food_reagents = list(/datum/reagent/consumable/nutriment = 5, /datum/reagent/consumable/capsaicin = 2)
...
/obj/item/food/donkpocket/warm/spicy
	...
	icon_state = "donkpocketspicy"
	food_reagents = list(/datum/reagent/consumable/nutriment = 5, /datum/reagent/medicine/omnizine = 2, /datum/reagent/consumable/capsaicin = 5)
...
/obj/item/food/donkpocket/teriyaki
	...
	food_reagents = list(/datum/reagent/consumable/nutriment = 5, /datum/reagent/consumable/soysauce = 2)
...
/obj/item/food/donkpocket/warm/teriyaki
	...
	icon_state = "donkpocketteriyaki"
	food_reagents = list(/datum/reagent/consumable/nutriment = 6, /datum/reagent/medicine/omnizine = 2, /datum/reagent/consumable/soysauce = 2)
	tastes = list("meat" = 2, "dough" = 2, "soy sauce" = 2)
	foodtypes = GRAIN
...
/obj/item/food/donkpocket/pizza
	...
	food_reagents = list(/datum/reagent/consumable/nutriment = 5, /datum/reagent/consumable/tomatojuice = 2)
...
/obj/item/food/donkpocket/warm/pizza
	...
	icon_state = "donkpocketpizza"
	food_reagents = list(/datum/reagent/consumable/nutriment = 5, /datum/reagent/medicine/omnizine = 2, /datum/reagent/consumable/tomatojuice = 2)
...
/obj/item/food/donkpocket/gondola
	...
	food_reagents = list(/datum/reagent/consumable/nutriment = 5, /datum/reagent/tranquility = 5)
...
/obj/item/food/donkpocket/warm/gondola
	...
	icon_state = "donkpocketgondola"
	food_reagents = list(/datum/reagent/consumable/nutriment = 5, /datum/reagent/medicine/omnizine = 2, /datum/reagent/tranquility = 10)
	tastes = list("meat" = 2, "dough" = 2, "inner peace" = 1)
	foodtypes = GRAIN
...
/obj/item/food/icecream/chocolate
	...
	food_reagents = list(/datum/reagent/consumable/nutriment = 4, /datum/reagent/consumable/cocoa = 1)
	ingredients = list(/datum/reagent/consumable/flour, /datum/reagent/consumable/sugar, /datum/reagent/consumable/cocoa)
