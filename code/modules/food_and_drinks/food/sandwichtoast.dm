...
/obj/item/food/grilled_cheese_sandwich
	...
	food_reagents = list(/datum/reagent/consumable/nutriment = 6, /datum/reagent/consumable/nutriment/vitamin = 1, /datum/reagent/carbon = 4)
...
/obj/item/food/cheese_sandwich
	...
	food_reagents = list(/datum/reagent/consumable/nutriment = 10, /datum/reagent/consumable/nutriment/vitamin = 1)
