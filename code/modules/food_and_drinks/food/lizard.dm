...
/obj/item/food/raw_tiziran_sausage
	...
	food_reagents = list(/datum/reagent/consumable/nutriment = 3, /datum/reagent/blood = 3)
...
/obj/item/food/raw_headcheese
	...
	food_reagents = list(/datum/reagent/consumable/nutriment = 5, /datum/reagent/consumable/sodiumchloride = 5)
...
/obj/item/food/headcheese_slice
	...
	food_reagents = list(/datum/reagent/consumable/nutriment = 1, /datum/reagent/consumable/sodiumchloride = 1)
	tastes = list("cheese" = 1, "salt" = 1)
	foodtypes = MEAT | GROSS
...
/obj/item/food/shredded_lungs
	...
	food_reagents = list(/datum/reagent/consumable/nutriment = 3, /datum/reagent/consumable/nutriment/vitamin = 2, /datum/reagent/consumable/capsaicin = 1)
...
/obj/item/food/lizard_escargot
	...
	food_reagents = list(/datum/reagent/consumable/nutriment = 5, /datum/reagent/consumable/garlic = 1)
...
/obj/item/food/fried_blood_sausage
	...
	food_reagents = list(/datum/reagent/consumable/nutriment = 3, /datum/reagent/consumable/sodiumchloride = 1, /datum/reagent/consumable/cooking_oil = 1)
...
/obj/item/food/lizard_fries
	...
	food_reagents = list(/datum/reagent/consumable/nutriment = 7, /datum/reagent/consumable/sodiumchloride = 1, /datum/reagent/consumable/bbqsauce = 2)
...
/obj/item/food/crispy_headcheese
	...
	food_reagents = list(/datum/reagent/consumable/nutriment = 4, /datum/reagent/consumable/cooking_oil = 1)
...
/obj/item/food/kebab/picoss_skewers
	...
	food_reagents = list(/datum/reagent/consumable/nutriment = 3, /datum/reagent/consumable/nutriment = 3, /datum/reagent/consumable/vinegar= 1, /datum/reagent/consumable/capsaicin = 1)
...
/obj/item/food/nectar_larvae
	...
	food_reagents = list(/datum/reagent/consumable/nutriment = 5, /datum/reagent/consumable/korta_nectar = 2, /datum/reagent/consumable/capsaicin = 1)
...
/obj/item/food/grilled_moonfish
	...
	food_reagents = list(/datum/reagent/consumable/nutriment = 5, /datum/reagent/consumable/nutriment = 3)
	tastes = list("fish" = 1)
	foodtypes = SEAFOOD
	burns_on_grill = TRUE
	w_class = WEIGHT_CLASS_SMALL
...
/obj/item/food/emperor_roll
	...
	food_reagents = list(/datum/reagent/consumable/nutriment = 11, /datum/reagent/consumable/nutriment/vitamin = 1)
...
/obj/item/food/soup/jellyfish
	...
	tastes = list("slime" = 1)
	foodtypes = SEAFOOD | VEGETABLES | GROSS
...
/obj/item/food/patzikula
	...
	food_reagents = list(/datum/reagent/consumable/nutriment = 8, /datum/reagent/consumable/nutriment/vitamin = 4, /datum/reagent/consumable/capsaicin = 1)
...
/obj/item/food/canned_jellyfish
	...
	food_reagents = list(/datum/reagent/consumable/nutriment = 4, /datum/reagent/toxin/mindbreaker = 2, /datum/reagent/consumable/sodiumchloride = 1)
...
/obj/item/food/desert_snails
	...
	food_reagents = list(/datum/reagent/consumable/nutriment = 4, /datum/reagent/consumable/sodiumchloride = 2)
...
/obj/item/food/larvae
	...
	food_reagents = list(/datum/reagent/consumable/nutriment = 4, /datum/reagent/consumable/honey = 2)
