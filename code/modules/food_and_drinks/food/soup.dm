...
/obj/item/food/soup/blood
	...
	food_reagents = list(/datum/reagent/consumable/nutriment = 6, /datum/reagent/blood = 10, /datum/reagent/water = 5, /datum/reagent/consumable/nutriment/vitamin = 10)
	tastes = list("iron" = 1)
	foodtypes = GROSS
...
/obj/item/food/soup/wingfangchu
	...
	trash_type = /obj/item/reagent_containers/glass/bowl
	food_reagents = list(/datum/reagent/consumable/nutriment = 9, /datum/reagent/consumable/soysauce = 10, /datum/reagent/consumable/nutriment/vitamin = 7)
	tastes = list("soy" = 1)
	foodtypes = MEAT
...
/obj/item/food/soup/nettle
	...
	food_reagents = list(/datum/reagent/consumable/nutriment = 5, /datum/reagent/water = 5, /datum/reagent/consumable/nutriment/vitamin = 9, /datum/reagent/medicine/omnizine = 5)
...
/obj/item/food/soup/hotchili
	...
	icon_state = "hotchili"
	food_reagents = list(/datum/reagent/consumable/nutriment = 4, /datum/reagent/consumable/capsaicin = 3, /datum/reagent/consumable/tomatojuice = 4, /datum/reagent/consumable/nutriment/vitamin = 4)
...
/obj/item/food/soup/coldchili
	...
	food_reagents = list(/datum/reagent/consumable/nutriment = 4, /datum/reagent/consumable/frostoil = 3, /datum/reagent/consumable/tomatojuice = 4, /datum/reagent/consumable/nutriment/vitamin = 4)
...
/obj/item/food/soup/monkeysdelight
	...
	food_reagents = list(/datum/reagent/consumable/nutriment = 3, /datum/reagent/consumable/banana = 5, /datum/reagent/consumable/nutriment/vitamin = 10)
...
/obj/item/food/soup/tomato/eyeball
	...
	food_reagents = list(/datum/reagent/consumable/nutriment = 10, /datum/reagent/consumable/tomatojuice = 10, /datum/reagent/consumable/nutriment/vitamin = 4, /datum/reagent/liquidgibs = 3)
...
/obj/item/food/soup/onion
	...
	food_reagents = list(/datum/reagent/consumable/nutriment = 7, /datum/reagent/medicine/oculine = 5, /datum/reagent/consumable/tomatojuice = 8, /datum/reagent/consumable/nutriment/vitamin = 5)
...
/obj/item/food/soup/bisque
	...
	icon_state = "bisque"
	food_reagents = list(/datum/reagent/consumable/nutriment = 6, /datum/reagent/water = 5, /datum/reagent/consumable/nutriment/vitamin = 6)
