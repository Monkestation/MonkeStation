...
/obj/item/food/canned/tomatoes
	...
	food_reagents = list(/datum/reagent/consumable/tomatojuice = 20, /datum/reagent/consumable/sodiumchloride = 2)
...
/obj/item/food/curd_cheese
	...
	food_reagents = list(/datum/reagent/consumable/nutriment = 3, /datum/reagent/consumable/cream = 1)
