...
/obj/item/popsicle_stick
	...
	custom_materials = list(/datum/material/plastic=20)
...
/obj/item/food/popsicle/jumbo
	...
	food_reagents = list(/datum/reagent/consumable/cocoa/hot_cocoa = 4, /datum/reagent/consumable/cream = 2, /datum/reagent/consumable/vanilla = 3, /datum/reagent/consumable/sugar = 2)
	overlay_state = "jumbo"
...
/obj/item/food/cornuto
	...
	food_reagents = list(/datum/reagent/consumable/nutriment = 6, /datum/reagent/consumable/cocoa/hot_cocoa = 4, /datum/reagent/consumable/cream = 2, /datum/reagent/consumable/vanilla = 4, /datum/reagent/consumable/sugar = 2)
	foodtypes = DAIRY | SUGAR
