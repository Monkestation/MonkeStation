...
/obj/item/food/burger/human
	...
	food_reagents = list(/datum/reagent/consumable/nutriment = 2, /datum/reagent/consumable/nutriment/vitamin = 5)
...
/obj/item/food/burger/corgi
	name = "corgi burger"
	desc = "You monster."
	food_reagents = list(/datum/reagent/consumable/nutriment = 2, /datum/reagent/consumable/nutriment/vitamin = 6)
	foodtypes = GRAIN | MEAT | GROSS

/obj/item/food/burger/appendix
	name = "appendix burger"
	desc = "Tastes like appendicitis."
	food_reagents = list(/datum/reagent/consumable/nutriment = 2, /datum/reagent/consumable/nutriment/vitamin = 7)
...
/obj/item/food/burger/roburger
	...
	icon_state = "roburger"
	food_reagents = list(/datum/reagent/consumable/nutriment = 8, /datum/reagent/nanomachines = 7, /datum/reagent/consumable/nutriment/vitamin = 6)
...
/obj/item/food/burger/roburgerbig
	...
	icon_state = "roburger"
	max_volume = 120
	food_reagents = list(/datum/reagent/consumable/nutriment = 11, /datum/reagent/nanomachines = 140, /datum/reagent/consumable/nutriment/vitamin = 15)
	tastes = list("bun" = 4, "lettuce" = 2, "sludge" = 1)
	foodtypes = GRAIN | TOXIC
...
/obj/item/food/burger/ghost
	...
	food_reagents = list(/datum/reagent/consumable/nutriment = 7, /datum/reagent/consumable/nutriment/vitamin = 13, /datum/reagent/consumable/sodiumchloride = 5)
...
/obj/item/food/burger/red
	...
	icon_state = "cburger"
	food_reagents = list(/datum/reagent/consumable/nutriment = 2, /datum/reagent/consumable/nutriment/vitamin = 6, /datum/reagent/colorful_reagent/powder/red = 10)
	foodtypes = GRAIN | MEAT
...
/obj/item/food/burger/orange
	...
	icon_state = "cburger"
	food_reagents = list(/datum/reagent/consumable/nutriment = 2, /datum/reagent/consumable/nutriment/vitamin = 6, /datum/reagent/colorful_reagent/powder/orange = 10)
	foodtypes = GRAIN | MEAT
...
/obj/item/food/burger/yellow
	...
	icon_state = "cburger"
	food_reagents = list(/datum/reagent/consumable/nutriment = 2, /datum/reagent/consumable/nutriment/vitamin = 6, /datum/reagent/colorful_reagent/powder/yellow = 10)
	foodtypes = GRAIN | MEAT
...
/obj/item/food/burger/green
	...
	icon_state = "cburger"
	food_reagents = list(/datum/reagent/consumable/nutriment = 2, /datum/reagent/consumable/nutriment/vitamin = 6, /datum/reagent/colorful_reagent/powder/green = 10)
	foodtypes = GRAIN | MEAT
...
/obj/item/food/burger/blue
	...
	icon_state = "cburger"
	food_reagents = list(/datum/reagent/consumable/nutriment = 2, /datum/reagent/consumable/nutriment/vitamin = 6, /datum/reagent/colorful_reagent/powder/blue = 10)
	foodtypes = GRAIN | MEAT
...
/obj/item/food/burger/purple
	...
	icon_state = "cburger"
	food_reagents = list(/datum/reagent/consumable/nutriment = 2, /datum/reagent/consumable/nutriment/vitamin = 6, /datum/reagent/colorful_reagent/powder/purple = 10)
	foodtypes = GRAIN | MEAT
...
/obj/item/food/burger/black
	...
	icon_state = "cburger"
	food_reagents = list(/datum/reagent/consumable/nutriment = 2, /datum/reagent/consumable/nutriment/vitamin = 6, /datum/reagent/colorful_reagent/powder/black = 10)
	foodtypes = GRAIN | MEAT
...
/obj/item/food/burger/white
	...
	icon_state = "cburger"
	food_reagents = list(/datum/reagent/consumable/nutriment = 2, /datum/reagent/consumable/nutriment/vitamin = 6, /datum/reagent/colorful_reagent/powder/white = 10)
	foodtypes = GRAIN | MEAT
...
/obj/item/food/burger/spell
	...
	food_reagents = list(/datum/reagent/consumable/nutriment = 8, /datum/reagent/consumable/nutriment/vitamin = 11)
...
/obj/item/food/burger/jelly/cherry
	food_reagents = list(/datum/reagent/consumable/nutriment = 6, /datum/reagent/consumable/cherryjelly = 10, /datum/reagent/consumable/nutriment/vitamin = 6)
	foodtypes = GRAIN | FRUIT
...
/obj/item/food/burger/empoweredburger
	...
	food_reagents = list(/datum/reagent/consumable/nutriment = 10, /datum/reagent/consumable/nutriment/vitamin = 1, /datum/reagent/consumable/liquidelectricity = 5)
