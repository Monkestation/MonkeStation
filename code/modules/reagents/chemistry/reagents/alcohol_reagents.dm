...
/datum/reagent/consumable/ethanol/thirteenloko/on_mob_life(mob/living/carbon/M)
	...
	M.AdjustSleeping(-40)
	M.adjust_bodytemperature(-5 * TEMPERATURE_DAMAGE_COEFFICIENT, BODYTEMP_REAGENT_HEAT)
	if(!HAS_TRAIT(M, TRAIT_ALCOHOL_TOLERANCE))
		M.Jitter(5)
	return ..()
...
/datum/reagent/consumable/ethanol/rum_coke
	...
	liquid_fire_power = 4 //MONKESTATION EDIT ADDITION
...
/datum/reagent/consumable/ethanol/toxins_special/on_mob_life(var/mob/living/M)
	M.adjust_bodytemperature(15 * TEMPERATURE_DAMAGE_COEFFICIENT, 0, BODYTEMP_REAGENT_HEAT + 20) //310.15 is the normal bodytemp.
	return ..()
...
/datum/reagent/consumable/ethanol/antifreeze/on_mob_life(mob/living/carbon/M)
	M.adjust_bodytemperature(20 * TEMPERATURE_DAMAGE_COEFFICIENT, 0, BODYTEMP_REAGENT_HEAT + 20) //310.15 is the normal bodytemp.
	return ..()
...
/datum/reagent/consumable/ethanol/peppermint_patty/on_mob_life(mob/living/carbon/M)
	...
	M.adjust_bodytemperature(5 * TEMPERATURE_DAMAGE_COEFFICIENT, 0, BODYTEMP_REAGENT_HEAT)
	..()
...
/datum/reagent/consumable/ethanol/icewing/on_mob_life(mob/living/carbon/M)
	M.adjust_bodytemperature(-8 * TEMPERATURE_DAMAGE_COEFFICIENT, BODYTEMP_REAGENT_HEAT)
