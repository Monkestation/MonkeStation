...
/datum/antagonist/ninja/proc/addObjectives()
	...
	var/datum/objective/plant_explosive/bomb_objective = new /datum/objective/plant_explosive()
	...
	var/datum/objective/communication_objective = new /datum/objective/terror_message()
	objectives += communication_objective
