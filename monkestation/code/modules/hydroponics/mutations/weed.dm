...
/datum/hydroponics/plant_mutation/forget_me_not
	created_product = /obj/item/food/grown/poppy/geranium/forgetmenot
	created_seed = /obj/item/seeds/poppy/geranium/forgetmenot
	required_lifespan = list(60, 90)
...
/datum/hydroponics/plant_mutation/jupiter_cup
	...
	created_seed = /obj/item/seeds/chanterelle/jupitercup
	required_endurance = list(50, INFINITY)
...
/datum/hydroponics/plant_mutation/blumpkin
	created_product = /obj/item/food/grown/blumpkin
